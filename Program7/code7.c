// Design, develop and implement a C/C++/Java
// program to simulate the working of Shortest
// remaining time and Round Robin (RR) scheduling
// algorithms. Experiment with different quantum sizes
// for RR algorithm.
